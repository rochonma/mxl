...
operator<<( std::ostream &os, const Flow &flow )
{
    ...
    os  << "- Flow [" << uuids::to_string( id ) << ']' << '\n'
        ...
        << '\t' << std::setw(18) << "flags"           << ": " << std::showbase << std::setw( 32 ) << std::setfill( '0' ) << std::hex << flow.info.flags << std::dec << '\n'
...
operator<<( std::ostream &os, const Grain &grain )
{
    ...
    os  << "- Grain" << '\n'
        ...
        << '\t' << std::setw(14) << "flags"         << ": " << std::showbase << std::setw( 32 ) << std::setfill( '0' ) << std::hex << grain.info.flags << std::dec << '\n'
